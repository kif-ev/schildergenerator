...
\newcommand{\footer}{Edit tex/support/header.tex to create your own design.}
\newcommand{\mylogo}{support/genericlogo}
...
\footer \hfill
\IfFileExists{ ${form.img} }{\includegraphics[width=.15\textwidth]{\mylogo}}{}
\hskip.5cm~
\vskip.5cm
} 
